...
func (e *EndpointService) AddEndpoint(name, apiUrl, apiKey, transformer, model, remark string, modelRedirects map[string]string) error {
...
func (e *EndpointService) UpdateEndpoint(index int, name, apiUrl, apiKey, transformer, model, remark string, modelRedirects map[string]string) error {
	endpoints := e.config.GetEndpoints()
