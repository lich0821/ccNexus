export default {
    ...
    modal: {
        ...
        modelRedirectsHelp: 'Redirect models in key → value format (higher priority than global model override)',
        addRedirectRow: 'Add Mapping',
        modelRedirectKeyPlaceholder: 'Original model',
        modelRedirectValuePlaceholder: 'Target model',
        remark: 'Remark',
